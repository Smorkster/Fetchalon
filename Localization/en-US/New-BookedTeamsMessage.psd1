...
ErrGeneral = Error occurred while calling server
ErrNoId = Can't find a user with the given id
ErrNoMail = Can't find a user with the given email address
ErrWebReq = Error when handling the booking
'@
