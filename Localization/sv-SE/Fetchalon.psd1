...
ContentBtnCopyOutputDataFormater = Formaterad data
...
ContentChbPropFilterNotVisible = Ej synlig
ContentChbPropFilterVisible = Synlig
ContentDgSearchResultsColMatchCountTitle = objekt funna
...
ContentTblCheckedForVisibleFilterTitle = ... synlighet i 'Förenklad vy'
...
StrDataFormaterCopied = Utdata har nu formaterats, och kopierats till clipboard, med dataformateraren
StrDefaultMainTitle = Fetchalon
StrDefaultPropHandlerDescription = Kör kod för attribut
StrDefaultPropHandlerTitle = Kör attributskript
StrEndTimeHasPassed = Sista tid för giltighet har har passerat
StrFunctionModuleUpdated = -modulen har blivit uppdaterat sedan du senast läste in den.
StrFunctionModuleUpdated2 = Modulen kommer läsas in igen innan funktionen startas.
...
StrPropHandlerDescriptionTitle = Handler beskrivning
StrPropHasPropHandler = Detta attribut har en handler.
StrPropHasPropHandlerChecked = En knapp kommer visas bredvid 'Kopiera'.
StrPropInfinityValue = Värde motsvarande 'Går aldrig ut'
