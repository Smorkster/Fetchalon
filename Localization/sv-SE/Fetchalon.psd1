...
ContentTBtnObjectDetailed = Klicka här för att spara inställningarna
...
StrSelectPropsDesc = Bocka för det värde som ska visas i standardvyn, klicka sedan här igen
