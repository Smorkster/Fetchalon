...
function Get-ComputersSameCostCenter
{
	<#
	.Synopsis
		Lista datorer på samma kostnadsställe
	.Description
		Lista alla datorer som är skrivna på samma kostnadsställe
	.MenuItem
		Lista datorer på samma kostnadsställe
	.SearchedItemRequest
		Required
...
function Get-LastLoggedIn
{
	...
	.Description
		List which users last logged in to multiple computers
	.MenuItem
	...
	.OutputType
		ObjectList
	.InputData
		ComputerNames List of computernames
	.Author
		Smorkster
	#>
...
function Open-SysManEdit
{
	...
	.Description
		Opens SysMan for changing information about the computer
	.MenuItem
		SysMan change information
	.SearchedItemRequest
		Required
...
function Open-SysManInstall
{
	...
	.Description
		Opens SysMan for installation of application
	.MenuItem
		SysMan for installation
	.SearchedItemRequest
		Required
...
function Open-SysManOsdMonitor
{
	...
	.Description
		Opens SysMan for monitoring of OSD installation
	.MenuItem
		SysMan OSD monitoring
	.SearchedItemRequest
		Required
...
function Open-SysManOsInstall
{
	...
	.Description
		Opens SysMan for installation of OS
	.MenuItem
		SysMan OS installation
	.SearchedItemRequest
		Required
...
function Open-SysManPrintAdd
{
	<#
	.Synopsis
		SysMan to add printer
	.Description
		Opens SysMan to add printer
	.MenuItem
		SysMan add printer
	.SearchedItemRequest
		Required
...
function Open-SysManPrintRemove
{
	<#
	.Synopsis
		SysMan to remove printer
	.Description
		Opens SysMan to remove printer
	.MenuItem
...
function Open-SysManUninstall
{
	...
	.Description
		Opens SysMan for uninstallation of application
	.MenuItem
		SysMan for uninstallation
	.SearchedItemRequest
		Required
...
function Send-ShutdownComputer
{
	...
	.Description
		For a shutdown of selected computer
	.MenuItem
		Force shutdown
	.SearchedItemRequest
		Required
...
function Send-Toast
{
	...
	.Synopsis
		Send toast message
	.Description
		Send a toast message to designated computer
	.MenuItem
		Send message
	.SearchedItemRequest
		Required
...
function Start-RemoteControl
{
	<#
	.Synopsis
		Start remote controll
	.Description
		Start CmRcViewer for a remote controls session
	.MenuItem
